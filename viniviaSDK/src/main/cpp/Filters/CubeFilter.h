#ifndef VINIVIA_SDK_CUBE_FILTER_H
#define VINIVIA_SDK_CUBE_FILTER_H
...
namespace ViniviaSDK
{
    ...
    class CubeFilter : public BaseFilter {
    public:
        /**
         * C-tor
         */
        CubeFilter() : BaseFilter() {}
        ...
        jlong InitializeFilter(jlong context) override {
            ...
            nativeContext->program = Graphics::CreateGLProgram(
                    ViniviaSDK::Filters::NoFilter::VERTEX_SHADER_SRC,
                    ViniviaSDK::Filters::NoFilter::FRAGMENT_SHADER_SRC);
...
#endif //VINIVIA_SDK_CUBE_FILTER_H