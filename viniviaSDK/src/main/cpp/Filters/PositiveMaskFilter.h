#ifndef VINIVIA_SDK_POSITIVE_MASK_FILTER_H
#define VINIVIA_SDK_POSITIVE_MASK_FILTER_H
...
namespace ViniviaSDK {
    namespace Filters::PositiveMaskFilter {
        // Vertex Shader
        ...
        constexpr char FRAGMENT_SHADER_SRC[] = R"SRC(
            ...
            void main()
            {
                ...
                // Output the result
                gl_FragColor = mix(maskColor, normalColor, maskColor.r);
            }
        )SRC";
    }

    class PositiveMaskFilter : public BaseFilter {
    public:
        /**
         * C-tor
         */
        PositiveMaskFilter() : BaseFilter() {}

        /**
         * D-tor
         */
        ~PositiveMaskFilter() override {}
...
#endif //VINIVIA_SDK_POSITIVE_MASK_FILTER_H